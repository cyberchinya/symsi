    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li class="dropdown"><a href="#"><span>О больнице</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        <li><a href="#">Администрация</a></li>
                        <li><a href="#">Структура клиники</a></li>
                        <li><a href="#">Список заведующих отделениями</a></li>
                        <li><a href="#">Список сотрудников фельдшерско-акушерских пунктов, амбулаторий</a></li>
